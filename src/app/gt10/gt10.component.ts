...
TargetProfileDesc = {
  ...
  `,
  THREE: `In the past we lived in tribes and as time evolved we slowly strayed away from this idea, however, for the Communal Wearer identifying their tribe is absolutely crucial. This stems from the need to work towards greater cause and reach a utopia. The Communal Wearer seeks positive change in everything they do and this is no exception when it comes to luxury; from concept, to creation and even communication is it absolutely necessary to highlight what greater cause is being worked towards. The Communal wearer has a high need of association and craves for community based experiences; exclusivity doesn’t matter to them. Affiliation is something this target strives for, for they welcome anyone and everyone to join their cause. The communal wearers are drawn to brands with significant community driven experiences, products unique and identifiable to their cause or services  to make a positive change. When we talk about making a positive change, we mean making a big one. They seek a change largely identifiable and translated through visual codes like a uniform associated to their cause; it's about the feeling of being able identify one of your own people. This target profile has a need to be profound, they seek depth in every product.`,
